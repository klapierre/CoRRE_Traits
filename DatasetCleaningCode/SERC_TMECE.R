...
c3count<-read.csv("Data/OriginalData/Sites/SERC_TMECE/1-CO2xComm Sedge Shoot Biomass 1987-2013.csv")%>%
  mutate(species="SC")%>%
...
write.csv(genus_sp, "Data/OriginalData/Sites/SERC_TMECE/genus_species_list.csv")


specieslist<-read.csv("Data/OriginalData/Sites/SERC_TMECE/genus_species_list2.csv")
...
write.csv(species3, "Data/CleanedData/Sites/Species csv/SERC_TMECE.csv")
