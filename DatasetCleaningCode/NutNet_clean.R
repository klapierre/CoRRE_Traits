...
## data
dat <- read.csv("Data/OriginalData/2020 update/Data/NutNet/nutnet_cover_01202021.csv", row.names = 1)
bio_dat <- read.csv("Data/OriginalData/2020 update/Data/NutNet/nutnet_anpp_012052021.csv", row.names = 1)
