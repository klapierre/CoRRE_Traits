################################################################################
##  CoRRE_N-fixers.R: Determining N-fixation status for CoRRE and GEx species.
##
##  Authors: Benton Taylor
################################################################################
...
setwd("C:\\Users\\kjkomatsu\\Dropbox (Smithsonian)\\working groups\\CoRRE\\CoRRE_database\\Data\\TRYCoRREMerge\\CORRE-TRY N Fixers")
...
setwd("C:\\Users\\kjkomatsu\\Dropbox (Smithsonian)\\working groups\\CoRRE\\CoRRE_database\\Data\\OriginalData\\Traits\\Categorical Traits\\N Fixers")

ct_orig<-read.csv("GEx_uniqueSpp_June2023.csv")
...
write.csv(ct_orig, file="GEx_TRY_species_list_N-fixers.csv", row.names=F) #write file to .csv
